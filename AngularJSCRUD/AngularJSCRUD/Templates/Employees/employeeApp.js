...
app.factory('crudServiceEmployess', function ($http, $routeParams) {
    ...
    crudEmpObj.getAll = function () {
        ...
        Emps = $http({ method: 'Get', url: '/Employee/Index'}).then(function (response) {
    ...
    crudEmpObj.getEmployeeByEmpId = function () {
        ...
        Emp = $http({ method: 'Get', url: '/Employee/Details/' + id }).then(function (response) {
            return response.data;
        });
        return Emp;
    }
    ...
    crudEmpObj.deleteByEmpId = function (empid) {
        ...
        Emp = $http({ method: 'Post', url: '/Employee/Delete/', params: { id: empid } }).then(function (response) {
            return response.data;
        });
        return Emp;
    };
    ...
    crudEmpObj.createEmployee = function (emp) {
        ...
        Emp = $http({ method: 'Post', url: '/Employee/Create/', data: emp }).then(function (response) {
            //return response.data;
    ...
    crudEmpObj.updateEmployee = function (emp) {
        ...
        Emp = $http({ method: 'Post', url: '/Employee/Edit/'+ id, data:emp }).then(function (response) {
            window.location.href = '#/Employees';
        });
        return Emp;
    };
